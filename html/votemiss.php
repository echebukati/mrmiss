...
?>
    <li id="<?php echo $x++;?>">
        ...
        <p><span><button name="missusiu" class="vote" value="<?php echo $row["fname"]; echo ' '; echo $row["lname"];?>" onclick="return confirm('Are you sure you want to vote <?php echo $row["fname"]; echo ' '; echo $row["lname"];?> as Miss USIU? Once you vote, you can not edit your response.');">Vote</button> for <?php echo $row["fname"]; echo ' '; echo $row["lname"];?></span></p>                          
	</li>
<?php
}
?>
